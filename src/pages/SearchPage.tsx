...
import { searchTMDB, searchTMDBWithActors, getByGenre, getTrendingMovies, getTrendingTV, getPopularMovies, getPopularTV, getContentByPerson, getPersonDetails, TMDBActor, TMDBPersonDetails } from '@/utils/tmdb';
...
export default function SearchPage() {
  ...
  const [isLoadingActorDetails, setIsLoadingActorDetails] = useState(false);
